...
Nodal core sign [0: absent, 1: present]:
1

Perinodal hyperechogenic ring [0: absent, 1: present]:
0

Cortical interruption [0: absent, 1: present]:
0

Echogenicity [0: homogeneous, 1: inhomogeneous]:
0

Focal intranodal deposit [0: absent, 1: hyperechoic, 2: hypoechoic, 3: both]:
0

Vascular flow localization [0: non vascularized, 1: central (hilum), 2: peripheral, 3: extranodal, 4: combined]:

Cortical thickening [0: not evaluable, 1: absent, 2: focal, 3: concentric, 4: eccentric]:
2

Vascular flow architecture pattern [0: non vascularized, 1: longitudinal axis, 2: scattered, 3: branched, 4: chaotic]:
2

Cortical-Medullar interface distortion [1: absent, 2: focal, 3: diffused, 4: not visible]:
3

Shape [1: elliptical, 2: rounded, 3: asymmetrical]:

Grouping [1: assente, 2: intermediate, 3: complete]:

Color score [1, 2, 3, 4, 5]:
